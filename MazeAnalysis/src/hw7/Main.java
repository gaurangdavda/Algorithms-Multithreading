...
public class Main {
	...
	public void solve() {
		...
		PuzzleSolver[] solvers = { new STPuzzleSolverRec(puzzle), new STPuzzleSolverDFS(puzzle),
				new STPuzzleSolverBFS(puzzle), new StudentMultiPuzzleSolver(puzzle) };
	...
	public static void main(String[] args) {
		...
		String puzzleLocationNotInProjectFolder = "maze-dist//"; // replace this
																	// with your
																	// puzzle
																	// directory
		String whichPuzzleToUse = "1000x1000.mz"; // which puzzle file to
		// load
	...
	private void read(String filename) throws IOException, ClassNotFoundException {
		PuzzleInputStream in = new PuzzleInputStream(new BufferedInputStream(new FileInputStream(filename)));
