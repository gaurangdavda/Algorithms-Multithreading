...
public class SimulationEvent {
	...
	public String toString() {
		...
		case CustomerStarting:
			return customer.getPriority() + " customer " + customer + " going to coffee shop.";

		case CustomerEnteredCoffeeShop:
			return customer.getPriority() + " customer " + customer + " entered coffee shop.";

		case CustomerPlacedOrder:
			return customer.getPriority() + " customer " + customer + " placing order " + orderNumber + " " + orderFood;

		case CustomerReceivedOrder:
			return customer.getPriority() + " customer " + customer + " received order " + orderNumber + " "
					+ orderFood;

		case CustomerLeavingCoffeeShop:
			return customer.getPriority() + " customer " + customer + " leaving coffee shop.";
