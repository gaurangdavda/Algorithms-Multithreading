...
/**
 * @Invariant The number of customers can be less than or equal to number of tables in the coffee shop
 * @Invariant The 3 machines can cook as many items in parallel as its capacity
 */
/**
...
public class Validate {
	...
	/**
	 * @Precondition event list should not be null
	 * 
	 * @Postcondition boolean flag is returned if all the conditions are met or no
	 */
	/** 
