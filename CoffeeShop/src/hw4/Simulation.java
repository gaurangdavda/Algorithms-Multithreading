...
public class Simulation {
	...
	/**
	 * @Invariant All the tables should be vacant.
	 * 
	 * @Precondition randomOrders can be True or False
	 * @Precondition numCustomers should be greater than 0
	 * @Precondition numCooks should be greater than 0
	 * @Precondition numTables should be greater than 0
	 * @Precondition machineCapacity should be greater than 0
	 * 
	 * @Postcondition returns a list of events
	 * 
	 */
	/**
